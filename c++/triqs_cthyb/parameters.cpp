...
namespace triqs_cthyb {
  ...
  void h5_write(h5::group h5group, std::string name, solve_parameters_t const &sp) {
    ...
    h5_write(grp, "measure_G_tau_impr_est", sp.measure_G_tau_impr_est);
  ...
  void h5_read(h5::group h5group, std::string name, solve_parameters_t &sp) {
    ...
    if( grp.has_key("measure_G_tau_impr_est") ) h5_read(grp, "measure_G_tau_impr_est", sp.measure_G_tau_impr_est);
